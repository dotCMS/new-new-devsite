...
export default function Hero() {
  return (
    <section className="container mx-auto px-4 py-16">
      <h1 className="mb-4 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl text-center">Build with dotCMS</h1>
      <p className="mx-auto mb-16 max-w-3xl text-lg text-muted-foreground sm:text-xl text-center">
        dotCMS empowers marketers, developers, and DevOps teams to create, manage, and deliver content-driven
